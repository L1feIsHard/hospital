/*
 ...
 Source Server         : daoyuhai
 Source Server Type    : MySQL
 Source Server Version : 80019
 Source Host           : 82.157.46.178:3306
...
CREATE TABLE `baoque`  (
  ...
  `baoqueNum` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `caigou`  (
  ...
  `shuliang` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `checkup`  (
  ...
  `registerid` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `doctor`  (
  ...
  `dstate` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `drugstore`  (
  ...
  `skullId` int(0) NULL DEFAULT NULL,
  `warehouseId` int(0) NULL DEFAULT NULL,
  `unit` int(0) NOT NULL,
...
CREATE TABLE `jilu`  (
  ...
  `jilutime` datetime(0) NULL DEFAULT NULL,
  ...
  `jilunumber` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `pharmacy`  (
  ...
  `drugstoreId` int(0) NULL DEFAULT NULL,
  `skullId` int(0) NULL DEFAULT NULL,
  `warehouseId` int(0) NULL DEFAULT NULL,
  `unit` int(0) NOT NULL,
  `sellingPrice` double NOT NULL,
...
CREATE TABLE `report`  (
  ...
  `sex` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `age` int(0) NULL DEFAULT NULL,
  `department` int(0) NULL DEFAULT NULL,
  `doctor` int(0) NULL DEFAULT NULL,
  `reportType` int(0) NULL DEFAULT NULL,
  `price` double NULL DEFAULT NULL,
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '412365199601236544', '超级管理员', 1, '武汉', '13183380755', '6af4d08340b548cbcce38353d9bcaab4', 'CEO', 1, 1, 'd21fd4');
INSERT INTO `sys_user` VALUES (28, 'mz', '412827199807156565', '门诊', 1, '河南', '13183365377', '488c3277b32f77bfd8bdf9bd2c3b3cc3', '门诊管理员', 2, 1, '6a285b');
